#!/usr/bin/env python3
#dude, fuck pyright, like fr. I'll try a little of zed, if I don't like it, well fuck it, microsoft my soul is your's once again#dude, fuck pyright, like fr. I'll try a little of zed, if I don't like it, well fuck it, microsoft my soul is your's once again#dude, fuck pyright, like fr. I'll try a little of zed, if I don't like it, well fuck it, microsoft my soul is your's once again
import subprocess
...
# status code
status_code = html_data("#regionHeader").attr("class").split(" ")[2].split("-")[2]#type:ignore 
# print(status_code)
...
prediction = prediction.replace("Chance of Rain", "") #type:ignore
